...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles.css */ \"./src/styles.css\");\n/* harmony import */ var _todoapp_todo__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./todoapp/todo */ \"./src/todoapp/todo.js\");\n/* harmony import */ var _todoapp_project__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./todoapp/project */ \"./src/todoapp/project.js\");\n/* harmony import */ var _todoapp_todoapp__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./todoapp/todoapp */ \"./src/todoapp/todoapp.js\");\n/* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modal */ \"./src/modal.js\");\n/* harmony import */ var _view_projectview__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./view/projectview */ \"./src/view/projectview.js\");\n/* harmony import */ var _view_todoview__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./view/todoview */ \"./src/view/todoview.js\");\n\n\n\n\n\n\n\n\nconst myTodos = [\n    \"Editing and removing existing projects\",\n    \"Editing and removing existing todos\",\n    \"Add due dates\",\n    \"Add priority to tasks\",\n    \"Add persistence using the Web Storage API\",\n];\n\nconst UIController = (function (){\n    // get elements\n    const todoContainer = document.getElementById(\"todo-container\");\n    const titleElement = document.getElementById(\"current-project-title\");\n    const projectList = document.getElementById(\"project-list\");\n\n    const app = new _todoapp_todoapp__WEBPACK_IMPORTED_MODULE_3__.TodoApp();\n\n    // Add my todo list\n    myTodos.forEach(title => {\n        app.addTodo(new _todoapp_todo__WEBPACK_IMPORTED_MODULE_1__.Todo(title, \"\", \"\", \"\", false));\n    });\n    \n    // Add example project and example todo\n    let exampleProject = new _todoapp_project__WEBPACK_IMPORTED_MODULE_2__.Project(\"Example Project\");\n    app.addProject(exampleProject);\n    let exampleTodo = new _todoapp_todo__WEBPACK_IMPORTED_MODULE_1__.Todo(\"Clean kitchen\", \"Clean the kitchen\", \"Today\", \"High\", false);\n    exampleProject.addTodo(exampleTodo);\n\n    // setup task and project add modals\n    (0,_modal__WEBPACK_IMPORTED_MODULE_4__.SetupAddModal)(\"add-task-dialog\", \"new-task-btn\", \"modal-task-cancel\", \"modal-task-add\", (event) => {\n        const inputTask = document.getElementById(\"task-input\");\n        const newTodo = new _todoapp_todo__WEBPACK_IMPORTED_MODULE_1__.Todo(inputTask.value, \"\", \"\", \"\", false);\n        app.currentProject.addTodo(newTodo);\n        inputTask.value = \"\";\n        render();\n    })\n\n    ;(0,_modal__WEBPACK_IMPORTED_MODULE_4__.SetupAddModal)(\"add-project-dialog\", \"new-project-btn\", \"modal-project-cancel\", \"modal-project-add\", (event) => {\n        const inputProject = document.getElementById(\"project-input\");\n        const newProject = new _todoapp_project__WEBPACK_IMPORTED_MODULE_2__.Project(inputProject.value);\n        app.addProject(newProject); \n        inputProject.value = \"\";\n        render();\n    })\n\n    function render() {\n        titleElement.textContent = app.currentProject.name;\n        renderProjectList()\n        renderTodoList()\n    }\n\n    function renderProjectList() {\n        projectList.innerHTML = \"\";\n\n        const ul = projectList.appendChild(document.createElement(\"ul\"));\n\n        function handleProjectClick(event) {\n            const clickedProjectName = event.target.textContent;\n            app.setCurrentProject(clickedProjectName);\n            render();\n        }\n\n        app.projects.forEach(project => {\n            const isCurrentProject = project === app.currentProject;\n            const projectElement = (0,_view_projectview__WEBPACK_IMPORTED_MODULE_5__.createProjectElement)(project.name, isCurrentProject, handleProjectClick);\n\n            ul.appendChild(projectElement);\n        });\n    }\n\n    function renderTodoList() {\n        todoContainer.innerHTML = \"\";\n\n        app.currentProject.todos.forEach(todo => {\n            const todoElement = (0,_view_todoview__WEBPACK_IMPORTED_MODULE_6__.createTodoElement)(todo.title);\n            todoContainer.appendChild(todoElement);\n        });\n    }\n\n    // initial update\n    render();\n\n})();\n\n//# sourceURL=webpack://odin-todo/./src/main.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   Todo: () => (/* binding */ Todo)\n/* harmony export */ });\nclass Todo {\n    constructor(\n        title,\n        description,\n        dueDate,\n        priority,\n        complete,\n    ) {\n        this.title = title;\n        this.description = description;\n        this.dueDate = dueDate;\n        this.priority = priority;\n        this.complete = complete;\n    }\n}\n\n//# sourceURL=webpack://odin-todo/./src/todoapp/todo.js?");
